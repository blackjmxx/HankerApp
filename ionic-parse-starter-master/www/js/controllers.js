...
.controller('HomeController', function($scope, $state, $rootScope) {
   ...
   if (!$rootScope.isLoggedIn) {
    ...
    //Create new object
    $scope.projects = [
    { title: 'iphone',spared :'100',aim:'1000',date:'12/02/1990'},
    {title: 'ipad',spared :"100",aim:"1000",date:'12/02/1990'},
    {title: 'itunes',spared :"100",aim:"1000",date:"12/02/1990"},
    {title: 'iwatch',spared :"100",aim:"1000",date:"12/02/1990"}
  ];
